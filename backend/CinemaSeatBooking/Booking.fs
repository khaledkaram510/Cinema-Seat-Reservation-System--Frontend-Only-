...
////let tryBookSeat layout r c = ...
////let bookByCode layout code = ...
////let cancelBooking layout code = ...
...
//    //match getStatusByCode layout "A3" with
//    //| Ok status -> printfn "Status: %A" status
//    //| Error e -> printfn "Error: %s" e


//    //match getStatusByCode layout "A3" with // The value or constructor 'layout' is not defined.
//    //    | Ok status -> printfn "Status: %A" status
//    //    | Error e -> printfn "Error: %s" e
